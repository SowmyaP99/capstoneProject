...
public class Flyaway {
	...
	public String[] exp_details() {
		...
		driver.findElement(By.xpath("//input[@name=\"email_id\"]")).sendKeys("sowmya@cisco.com");
		driver.findElement(By.xpath("//input[@name=\"pwd\"]")).sendKeys("sowmya@123");
		driver.findElement(By.xpath("//button")).click();
		driver.findElement(By.linkText("Logout")).click();
		
		
		String exp_email="sowmya@parth.com";
		String exp_pwd ="sowmya@456";
		String exp_name = "sowmya_p";
		String exp_adress ="Kadubeesanahalli";
...
//		driver.close();
	...
	public int Login_SearchFlight_Validate() {
		...
		driver.get("http://localhost:8080/FlyAway/");
		driver.findElement(By.linkText("Login/Signup")).click();
		driver.findElement(By.xpath("//input[@name=\"email_id\"]")).sendKeys("sowmya@parth.com");
		driver.findElement(By.xpath("//input[@name=\"pwd\"]")).sendKeys("sowmya@456");
		driver.findElement(By.xpath("//button")).click();
